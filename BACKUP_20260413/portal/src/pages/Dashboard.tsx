    ...
    <div className="theater-container" style={{ paddingTop: 0, paddingBottom: 150 }}>
      <div style={{ marginBottom: 100 }}>
        <div className="firm-intel-tag" style={{ marginBottom: 20 }}>
          <span className="tag-line" /> OPERATIONAL COMMAND
        </div>
        <h1 className="serif-title" style={{ fontSize: '5rem', marginBottom: 16 }}>Intelligence <em>Hub</em></h1>
        <p style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,0.3)', fontWeight: 200, maxWidth: 700, lineHeight: 1.8 }}>The internal firm-wide operational command centre for strategic mandates, professional telemetry, and relationship intelligence.</p>
      </div>
        ...
        {statCards.map(c => (
          <div key={c.label} className="portal-panel" style={{ padding: '80px 48px' }}>
            ...
            <div style={{ fontFamily: "var(--font-serif)", fontSize: '6.5rem', fontWeight: 300, lineHeight: 0.8, color: 'white' }}>
              {c.value}<span style={{ fontSize: '1.2rem', verticalAlign: 'top', opacity: 0.2, marginLeft: 10 }}>†</span>
            </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 450px', gap: 80 }}>
        ...
        <div className="portal-panel" style={{ padding: 0 }}>
          <div style={{ padding: '60px 60px', borderBottom: '1px solid rgba(255,255,255,0.02)' }}>
            <div className="firm-intel-tag"><span className="tag-line" /> OPERATIONAL TELEMETRY</div>
            ...
            <div className="portal-activity-list" style={{ marginTop: 0 }}>
              ...
              {activities.length === 0 && (
                <div style={{ padding: '100px 20px', textAlign: 'center', opacity: 0.05 }}>
                  <p className="serif-title" style={{ fontSize: '1.6rem', fontStyle: 'italic' }}>Awaiting institutional telemetry...</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
          ...
          <div className="portal-panel" style={{ padding: 60, background: 'rgba(255, 153, 51, 0.01)', borderColor: 'rgba(255,153,51,0.05)' }}>
             <div className="firm-intel-tag" style={{ color: 'var(--saffron)', marginBottom: 20, fontSize: '0.5rem' }}>SECURITY PROTOCOL</div>
             <p style={{ fontSize: '0.8rem', opacity: 0.3, lineHeight: 2, fontWeight: 200 }}>All institutional sessions are end-to-end encrypted. Audit trails are maintained for professional compliance under Section 43A IT Act.</p>
          </div>
        </div>
      </div>
    </div>
...
const Timesheets = () => {
  ...
  return (
    <div className="portal-content" style={{ paddingBottom: selectedIds.length > 0 ? 100 : 0 }}>
      ...
      <div style={{ marginBottom: 100 }}>
        <div className="firm-intel-tag" style={{ marginBottom: 20 }}>
          <span className="tag-line" /> PERSONNEL OPERATIONS
        </div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <div>
            <h1 className="serif-title" style={{ fontSize: '5rem', marginBottom: 16 }}>Time <em>Tracking</em></h1>
            <p style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,0.3)', fontWeight: 200, maxWidth: 700, lineHeight: 1.8 }}>Operational audit of professional hours and strategic time allocation across the firm's portfolio.</p>
          </div>
            ...
            <tbody>
              {logs.map(log => (
                <tr key={log.id} 
                  ...
                  className={selectedIds.includes(log.id) ? 'row-selected' : ''}
                >
                  {profile?.role === 'admin' && (
                    <td>
                      <input 
...
const Expenses = () => {
  ...
  return (
    <div className="portal-content" style={{ paddingBottom: selectedIds.length > 0 ? 100 : 0 }}>
      {/* Action Bar */}
      {selectedIds.length > 0 && profile?.role === 'admin' && (
        <div className="portal-batch-bar">
          <div className="batch-content">
      ...
      <div style={{ marginBottom: 100 }}>
        <div className="firm-intel-tag" style={{ marginBottom: 20 }}>
          <span className="tag-line" /> FINANCIAL AUDIT
        </div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <div>
            <h1 className="serif-title" style={{ fontSize: '5rem', marginBottom: 16 }}>Expense <em>List</em></h1>
            <p style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,0.3)', fontWeight: 200, maxWidth: 700, lineHeight: 1.8 }}>Centralized ledger of out-of-pocket expenses, professional disbursements, and strategic resource allocation.</p>
          </div>
          <div style={{ paddingBottom: 12, display: 'flex', gap: 12 }}>
            {profile?.role === 'admin' && (
  ...
  return (
    <div className="theater-container" style={{ paddingTop: 80, paddingBottom: 150 }}>
      <div style={{ marginBottom: 100 }}>
        ...
        <h1 className="serif-title" style={{ fontSize: '5rem', marginBottom: 16 }}>Welcome, <em>{profile.full_name}</em></h1>
        <p style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,0.3)', fontWeight: 200, maxWidth: 700, lineHeight: 1.8 }}>
          Institutional oversight of your active mandates and strategic requests under Adveris Advisors governance.
        </p>
      </div>

      <div className="portal-panel" style={{ padding: 0, overflow: 'visible' }}>
        <div className="portal-panel-header" style={{ padding: '60px 60px', borderBottom: '1px solid rgba(255,255,255,0.02)' }}>
          <h2 className="serif-title" style={{ fontSize: '2.4rem' }}>Your <em>Mandates</em></h2>
        </div>
